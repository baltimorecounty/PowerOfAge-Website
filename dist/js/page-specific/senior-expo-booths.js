...
seniorExpo.pageSpecific.seniorExpoBooths = function ($) {
  ...
  */
	var loadHtml = function loadHtml(year, callback) {
		$.ajax('/exhibitors/' + year + '-exhibitors.html').done(function (boothAssigmentData) {
